...
This project will attempt to predict board game rating from the game
category, using the [Tidy Tuesday week 4 data on board
games.](https://github.com/rfordatascience/tidytuesday/blob/master/data/2022/2022-01-25/readme.md)
...
Lets do some feature engineering for the boardgamecategory variable. The
tidymodels framework allows for some flexibility in terms of feature
engineering, in this case we need to incorporate a custom feature
engineering function to accommodate the structure of the variable.Lets
start by creating the splits:
...
The models are not very good, but lets compare the predicted results to
the true values:
...
This fitted workflow object can now be used for prediction. Lets predict
